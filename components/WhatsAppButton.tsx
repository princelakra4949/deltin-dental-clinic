...
export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/917090801004?text=Hello%2C%20I%20would%20like%20to%20book%20an%20appointment%20at%20Deltin%20Dental%20Clinic."
      target="_blank"
    ...
    >
      {/* Tooltip */}
      <span className="hidden sm:block bg-navy text-white text-xs font-semibold px-3 py-1.5 rounded-full
